...
namespace Querys
{
    ...
    public class RestaurantReservationQuerys : DatabaseInfo
    {
        ...
        public RestaurantReservation GetReservation(int Id)
        {
            ...
            db.Close();
            var reservering = new RestaurantReservation(row.Id, row.RestaurantId, row.UserInfoId, row.AmountOfPersons, row.Time);
            return reservering;
        }
        ...
        public RestaurantReservation EditReservation(RestaurantReservation restaurantReservation)
        {
            ...
            db.QuerySingle(dbCommand, restaurantReservation.Id, restaurantReservation.AmountOfPersons, restaurantReservation.Time);
            db.Close();
